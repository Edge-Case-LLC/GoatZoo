...
// import VideoPlayer from "react-native-video-cache";
...
class Video extends PureComponent {
  ...
  onSeekRelease(percent) {
    ...
    this.props.getVideoDuration(seconds);
  }
  ...
  toggleFS() {
    Platform.OS === "ios"
      ...
      : this.pause(),
      Platform.OS === "android" && this.props.dismissModal(this.props?.url);
    // this.setState({fullScreen: !this.state.fullScreen}, () => {
    //   Orientation.getOrientation((e, orientation) => {
    //     if (this.state.fullScreen) {
    //       const initialOrient = Orientation.getInitialOrientation();
  ...
  progress(time) {
    ...
    this.props.getVideoDuration(currentTime);
  }
